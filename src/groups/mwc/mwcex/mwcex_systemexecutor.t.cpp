...
//
// Testing:
//   mwcex::SystemExecutor::singleton
// ------------------------------------------------------------------------
{
    mwcex::SystemExecutor_Context* ctx1 =
        &mwcex::SystemExecutor_Context::singleton();
    mwcex::SystemExecutor_Context* ctx2 =
        &mwcex::SystemExecutor_Context::singleton();
...
//
// Testing:
//   'mwcex::SystemExecutor_Context's constructor
//   'mwcex::SystemExecutor_Context's destructor
// ------------------------------------------------------------------------
{
    ...
    mwcex::SystemExecutor_Context& context =
        mwcex::SystemExecutor_Context::initSingleton(&alloc);
    ...
    mwcex::SystemExecutor_Context::shutdownSingleton();
...
//
// Plan:
//   1. Default-construct an instance of 'mwcex::SystemExecutor'. Check
//      postconditions.
//
//   2. ThreadAttributes-construct an instance of 'mwcex::SystemExecutor'.
//      Check postconditions.
//
// Testing:
//   mwcex::SystemExecutor's creators
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;

    // initialize the context singleton with the test allocator
    mwcex::SystemExecutorContextGuard contextGuard(&alloc);
    ...
    // 2. ThreadAttributes-construct
    {
        ...
        // create executor
        mwcex::SystemExecutor ex(attr, &alloc);
...
//
// Testing:
//   mwcex::SystemExecutor's comparison operators
// ------------------------------------------------------------------------
{
    bslma::TestAllocator alloc;
    ...
    {
        mwcex::SystemExecutor ex1(bslmt::ThreadAttributes(), &alloc);
        mwcex::SystemExecutor ex2 = ex1;
    ...
    {
        mwcex::SystemExecutor ex1(bslmt::ThreadAttributes(), &alloc);
        mwcex::SystemExecutor ex2(bslmt::ThreadAttributes(), &alloc);
    ...
    // 5. executors has non-identical attributes
    {
        ...
        mwcex::SystemExecutor ex1(attr1, &alloc);
        mwcex::SystemExecutor ex2(attr2, &alloc);
